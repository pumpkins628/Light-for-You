...
const int buttonPin_Left = 3;    
const int buttonPin_Right = 4;    
const int buttonPin_Hazard = 9;
...
void setup() {
  ...
  pinMode(buttonPin_Hazard, INPUT_PULLUP);
...
void loop() {
  ...
  buttonState_Hazard = digitalRead(buttonPin_Hazard);
  
  if(buttonState_Hazard == LOW)
  {
    Serial.print("H");
